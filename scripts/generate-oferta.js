...
const cats = [
  {
    ...
    products: [
      { name: "Torebka Feronia", price: "od 395 zł", folder: 4 },
      { name: "Torebka Flora", price: "od 240 zł", folder: 3 },
      { name: "Torebka Mellona", price: "od 240 zł", folder: 7 },
      { name: "Torebka Aurora", price: "od 160 zł", folder: 15 },
      { name: "Torebka Bellona", price: "od 165 zł", folder: 14 },
      { name: "Torebka Wenus", price: "od 165 zł", folder: 6 },
      { name: "Torebka Westa", price: "od 190 zł", folder: 5 },
      { name: "Torebka Diana", price: "od 265 zł", folder: 1 },
      { name: "Torebka Izyda", price: "od 235 zł", folder: 11 },
      { name: "Torebka Carmenta", price: "od 210 zł", folder: 12 },
      { name: "Torebka Luna", price: "od 265 zł", folder: 8 },
      { name: "Torebka Ceres", price: "od 220 zł", folder: 13 },
      { name: "Torebka Junona", price: "od 395 zł", folder: 9 },
      { name: "Torebka Concordia", price: "od 320 zł", folder: 2 },
      { name: "Torebka Febris", price: "od 180 zł", folder: 10 },
    ],
  },
  {
    slug: "plecaki",
